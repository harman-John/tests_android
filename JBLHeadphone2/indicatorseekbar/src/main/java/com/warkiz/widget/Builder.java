...
public class Builder {
    ...
    int trackProgressColor = Color.parseColor("#FF4802");
    boolean trackRoundedCorners = false;
    //thumbText
    int thumbTextColor = Color.parseColor("#FFFFFF");
    boolean showThumbText = false;
    //thumb
    int thumbSize = 0;
    int thumbColor = Color.parseColor("#C0C0C0");
    ...
    Builder(Context context) {
        ...
        this.indicatorTextSize = SizeUtils.sp2px(context, 0);
        this.trackBackgroundSize = SizeUtils.dp2px(context, 4);
        this.trackProgressSize = SizeUtils.dp2px(context, 4);
        this.tickMarksSize = SizeUtils.dp2px(context, 12);
        this.tickTextsSize = SizeUtils.sp2px(context, 13);
        this.thumbSize = SizeUtils.dp2px(context, 28);
    }
    ...
    public Builder indicatorContentView(@NonNull View indicatorContentView) {
        ...
        this.indicatorContentView.setVisibility(View.GONE);
        return this;
    }
    ...
    public Builder indicatorTopContentView(View topContentView) {
        ...
        this.indicatorTopContentView.setVisibility(View.GONE);
        return this;
    }
